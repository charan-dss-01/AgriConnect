  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-r from-white to-orange-200">
      <div className="h-full max-w-4xl mx-auto flex flex-col p-3">
        {/* Fixed Header */}
        <header className="text-center py-4 mt-16">
        </header>
        ...
        >
          {chatHistory.length === 0 ? (
            ...
            <div className="welcom-screen flex flex-col items-center justify-center text-center p-6">
              <img src={sarahImage} alt="sarah Hash include chatbot" className="bot-img mb-4" />
              <div className="hide-on">
                ...
                <p className="powered-by text-gray-500">
                  Powered By <span className="gemini font-bold">Gemini <img src={gemini} alt="gemini image" className="inline h-4" /></span>
                </p>
              </div>
            </div>
          ) : (
                ...
                <div key={index} className={`mb-4 ${chat.type === 'question' ? 'text-right' : 'text-left'}`}>
                  <div className="flex items-start gap-2">
                    {chat.type === 'question' && profile?.photo?.url && (
                      <img src={profile.photo.url} alt="User icon" className="w-6 h-6 rounded-full" />
                    )}
